...
public class DataTransformer {
	...
	// Done
	public static final String INPUT_BUCKET_NAME = "entrada-edward";

	// Done Set output bucket name (must be globally unique)
	public static final String OUTPUT_BUCKET_NAME = "salida-edward";
	...
	private static AmazonS3 createS3Client() {
		// Done Replace the solution with your own code

		s3ClientForStudentBuckets = AmazonS3ClientBuilder.standard().build();

		return s3ClientForStudentBuckets;
	}
	...
	private static S3Object getObject(AmazonS3 s3ClientForStudentBuckets2, String bucketName, String fileKey) {
		// DONE: Replace the solution with your own code
		System.out.println("USando mi solucion");
